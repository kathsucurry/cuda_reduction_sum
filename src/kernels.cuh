...
#include "kernels/03_reposition_syncthread.cuh"
#include "kernels/04_thread_coarsening_two_elements.cuh"
#include "kernels/04_thread_coarsening.cuh"
#include "kernels/04_thread_coarsening_uncoalesced.cuh"
#include "kernels/05_unroll_last_warp.cuh"
