...
__global__ void batched_reposition_syncthread(
...
template <size_t NUM_THREADS>
void launch_batched_reposition_syncthread(
    float* Y,
    float const* X,
    size_t batch_size,
    size_t num_elements_per_batch,
    ...
    batched_reposition_syncthread<NUM_THREADS>
...
template <size_t NUM_THREADS>
void profile_reposition_syncthread(
    size_t string_width,
    Elements& elements,
    float* Y_d,
    float *X_d,
